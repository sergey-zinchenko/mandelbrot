...
void inline __attribute__((always_inline)) Mandelbrot_0_simd(int h, uint *pResult) {
    ...
    for (int w = 0; w < WIDTH; w += 16) {
        ...
        int i2 = 0;
        do {
            const __m256 zReNewVec1 = _mm256_add_ps(_mm256_sub_ps(_mm256_mul_ps(zReVec1, zReVec1), _mm256_mul_ps(zImVec1, zImVec1)), cxVec1);
            const __m256 zReNewVec2 = _mm256_add_ps(_mm256_sub_ps(_mm256_mul_ps(zReVec2, zReVec2), _mm256_mul_ps(zImVec2, zImVec2)), cxVec2);
            ...
            const __m256 mag2Vec1 = _mm256_add_ps(_mm256_mul_ps(zReNewVec1, zReNewVec1), _mm256_mul_ps(zImNewVec1, zImNewVec1));
            const __m256 mag2Vec2 = _mm256_add_ps(_mm256_mul_ps(zReNewVec2, zReNewVec2), _mm256_mul_ps(zImNewVec2, zImNewVec2));

            const __m256i maskVec1 = _mm256_add_epi32(_mm256_castps_si256(_mm256_cmp_ps(mag2Vec1, FourVec, _CMP_LT_OQ)), IdentVector);
            const __m256i maskVec2 = _mm256_add_epi32(_mm256_castps_si256(_mm256_cmp_ps(mag2Vec2, FourVec, _CMP_LT_OQ)), IdentVector);
            ...
            const __m256 zImNewVec3 = _mm256_add_ps(_mm256_mul_ps(_mm256_mul_ps(zReVec1, zImVec1), TwoVec), cyVec);
            const __m256 mag2Vec3 = _mm256_add_ps(_mm256_mul_ps(zReNewVec3, zReNewVec3),
                                                  _mm256_mul_ps(zImNewVec3, zImNewVec3));
            const __m256i maskVec3 = _mm256_add_epi32(_mm256_castps_si256(_mm256_cmp_ps(mag2Vec3, FourVec, _CMP_LT_OQ)),
                                                      IdentVector);
            breakVec1 = _mm256_or_si256(maskVec3, breakVec1);
            ...
            const __m256 zImNewVec4 = _mm256_add_ps(_mm256_mul_ps(_mm256_mul_ps(zReVec2, zImVec2), TwoVec), cyVec);
            const __m256 mag2Vec4 = _mm256_add_ps(_mm256_mul_ps(zReNewVec4, zReNewVec4),
                                                  _mm256_mul_ps(zImNewVec4, zImNewVec4));
            const __m256i maskVec4 = _mm256_add_epi32(_mm256_castps_si256(_mm256_cmp_ps(mag2Vec4, FourVec, _CMP_LT_OQ)),
                                                      IdentVector);
            breakVec2 = _mm256_or_si256(maskVec4, breakVec2);
